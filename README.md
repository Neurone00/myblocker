...
- **Deep clean (beta, Advanced)**: routes all traffic through Adbrella's own userspace TCP/UDP relay instead of only DNS. Phase 1 of in-page filtering for Chrome; transparent for now, no page changes yet.
